<script lang="ts">
  // TenantApp is the shell mounted on the tenant-VLAN :8088 listener.
  // STATICALLY imports the user surface + the tenant-admin pages :
  // audit log (tenant-scoped), DNS (tenant zones), security groups,
  // scripts catalogue, scheduling rules, registry browser.
  //
  // Stops short of the infra surface — no Plugins, no Federation, no
  // Inventory, no Network Topology, no Groups/Users tree.
